...
export const metadata: Metadata = {
  ...
  description: 'Anvi Digital is a growth agency focused on building reliable, scalable demand systems.',
};
  ...
  return (
    <>
      ...
      <main id="main-content">
            ...
            <div className="stagger-grid">
              <div className="col-start-1 col-span-12 md:col-start-7 md:col-span-6 border-l-4 border-on-surface pl-8 py-4">
                ...
                <p className="text-base md:text-lg font-light leading-relaxed text-on-surface-variant/70">
                  We combine SEO, paid media, and intelligent automation to help businesses generate consistent, high-quality enquiries without guesswork.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-16">
              ...
              <div className="md:max-w-lg md:pt-16">
                ...
                <p className="text-xl font-light leading-relaxed text-on-surface-variant mb-8">
                  We bring them together by designing SEO and paid media as a single system. This allows performance to improve over time while reducing cost per lead.
                </p>
                <div className="w-12 h-2 bg-secondary mb-8" />
                <p className="text-xl font-medium text-on-surface">
                  Our focus is on building long-term, compounding growth rather than short-term spikes.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="stagger-grid">
              <div className="col-start-1 col-span-12 md:col-start-2 md:col-span-10 lg:col-start-3 lg:col-span-8">
                <p className="text-xl md:text-2xl font-light text-on-surface-variant mb-12 leading-relaxed">
                  Anvi Digital is built on experience across Australia’s leading media and technology companies, along with consulting engagements across 70+ businesses in real estate, finance, media, SaaS, and more.
                </p>
                ...
                <div className="border-l-4 border-on-surface pl-8 py-4 mb-16">
                  <p className="text-lg md:text-xl font-light text-on-surface leading-relaxed">
                    At the centre of it is <strong className="font-bold">Rama</strong>, bringing over 16 years of hands-on experience across SEO, growth, and product. This ensures every strategy is practical, measurable, and tied to real execution.
                  </p>
                </div>
          ...
          <div className="max-w-screen-2xl mx-auto relative z-10">
            <div className="mb-24 flex flex-col md:flex-row justify-between items-end gap-8">
              <div>
                ...
                <p className="text-2xl max-w-xl text-on-surface-variant font-light">
                  When the right foundations are in place, results are easier to scale.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              {[
                {
                  title: "Discovery",
                  description: "Growth starts when your business is visible at the moment people are actively searching. We focus on capturing high-intent demand across search and digital channels.",
                  borderColor: "border-secondary",
                  hoverBg: "hover:bg-on-background hover:text-surface"
                },
                {
                  title: "Trust",
                  description: "Visibility alone is not enough. We help turn attention into action by improving relevance, clarity, and user experience across every touchpoint.",
                  borderColor: "border-on-surface",
                  hoverBg: "hover:bg-secondary hover:text-on-secondary"
                },
                {
                  title: "Compounding",
                  description: "Sustainable growth comes from continuous improvement. We build systems that evolve, learn from data, and deliver better results over time.",
                  borderColor: "border-secondary",
                  hoverBg: "hover:bg-on-background hover:text-surface"
                }
              ].map((item, i) => (
        ...
        {/* ─── WHAT WE DO ─── */}
        <section className="py-32 px-8 bg-on-background text-surface relative overflow-hidden">
          <div className="max-w-screen-2xl mx-auto relative z-10">
            <span className="font-label uppercase tracking-[0.3em] text-xs text-secondary font-bold mb-6 block">
              Capabilities
            </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="border-t-2 border-surface/20 pt-8">
                <h3 className="text-3xl font-black uppercase mb-4 text-secondary">SEO & AI Search</h3>
                <p className="text-lg font-light text-surface/80">Technical SEO, programmatic content, and optimisation for modern search experiences.</p>
              </div>
              <div className="border-t-2 border-surface/20 pt-8">
                <h3 className="text-3xl font-black uppercase mb-4 text-secondary">Paid Media</h3>
                <p className="text-lg font-light text-surface/80">Performance-driven campaigns across Google and social platforms.</p>
              </div>
              <div className="border-t-2 border-surface/20 pt-8">
                <h3 className="text-3xl font-black uppercase mb-4 text-secondary">Growth Strategy</h3>
                <p className="text-lg font-light text-surface/80">Positioning, go-to-market planning, and conversion optimisation.</p>
              </div>
              <div className="border-t-2 border-surface/20 pt-8">
                <h3 className="text-3xl font-black uppercase mb-4 text-secondary">Automation</h3>
                <p className="text-lg font-light text-surface/80">AI-driven workflows that improve efficiency and decision-making.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 px-8 bg-surface-container-low">
          <div className="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24">
            ...
            <div>
              ...
              <h2 className="text-5xl font-black uppercase tracking-tighter mb-12">How We Work</h2>
              <div className="space-y-12">
                {[
                  { title: "Understand", desc: "We assess your current performance, market, and opportunities." },
                  { title: "Build", desc: "We implement strong foundations across SEO, paid media, and data." },
                  { title: "Improve", desc: "We refine performance continuously using real insights." },
                  { title: "Scale", desc: "We expand what works to drive sustainable growth." }
                ].map((step, i) => (
                  <div key={step.title} className="flex gap-6">
                    <span className="text-2xl font-black text-secondary">{String(i + 1).padStart(2, "0")}</span>
                    <div>
                      <h3 className="text-2xl font-black uppercase tracking-tight mb-2">{step.title}</h3>
                      <p className="text-lg font-light text-on-surface-variant">{step.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div>
              ...
              <h2 className="text-5xl font-black uppercase tracking-tighter mb-12">Our Principles</h2>
              <ul className="space-y-6">
                {[
                  ...
                  <li key={principle} className="flex items-start gap-4">
                    ...
                    <span className="text-xl font-light text-on-surface-variant leading-relaxed">{principle}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        {/* ─── FINAL THOUGHT ─── */}
        <section className="py-32 px-8 bg-secondary flex flex-col items-center text-center relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter max-w-4xl leading-tight mb-8 text-on-secondary">
            Growth becomes far more predictable when it is built on the right system.
          </h2>

  ...
  return (
    <>
      ...
      <main id="main-content">
        {/* Hero */}
        <section className="min-h-[80vh] flex flex-col justify-end pt-32 pb-16 px-8 max-w-screen-2xl mx-auto">
          <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="md:col-start-7 md:col-span-6 border-l-4 border-on-surface pl-8 py-4">
              <p className="text-base md:text-2xl font-light leading-snug mb-8">
                Full-funnel paid media that creates demand at the top and
                captures it at the bottom — working as one system.
              </p>
              <a
                href="#contact"

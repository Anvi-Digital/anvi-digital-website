  ...
  return (
    <>
      ...
      <main id="main-content">
            ...
            <div className="stagger-grid">
              <div className="col-start-1 col-span-12 md:col-start-7 md:col-span-6 border-l-4 border-on-surface pl-8 py-4">
                ...
                <p className="text-base md:text-lg font-light leading-relaxed mb-8 text-on-surface-variant/70">
                  Build a predictable pipeline of high-intent traffic through search,
                  powered by strategy, content, and meticulous technical execution.
                </p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-16">
              ...
              <div className="md:max-w-lg md:pt-16">
                <p className="text-xl md:text-2xl font-light leading-relaxed text-on-surface-variant mb-8">
                  Search Engine Optimisation is not just about rankings. It’s about
                  showing up when your customers are actively looking, and turning
                  that intent into enquiries.
                </p>
                <p className="text-xl font-light leading-relaxed text-on-surface-variant mb-8">
                  Most businesses don’t fail at SEO because of a lack of effort. They
                  fail because there’s <strong className="font-bold text-on-surface">no system behind it.</strong> That’s exactly what we build.
                </p>
        ...
        <section className="py-32 px-8 bg-secondary/10 relative">
          <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              {/* Card 01 */}
              <div className="group relative bg-surface p-10 lg:p-14 border-l-8 border-secondary flex flex-col hover:bg-on-background hover:text-surface transition-all duration-500 min-h-[340px]">
                ...
                <p className="text-lg font-light leading-relaxed mb-8 flex-grow">
                  Built for scale, complexity, and large platforms. We engineer technical SEO architectures that support thousands of pages seamlessly without breaking.
                </p>
                <div className="flex flex-wrap gap-2 mt-auto">
                  {["Technical SEO at scale", "Site architecture", "Automation"].map((tag, idx) => (
                    <span key={idx} className="text-xs uppercase tracking-widest font-bold border border-current px-3 py-1 opacity-70">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              {/* Card 02 */}
              <div className="group relative bg-surface p-10 lg:p-14 border-l-8 border-primary-container flex flex-col hover:bg-secondary hover:text-on-secondary transition-all duration-500 min-h-[340px]">
                <h3 className="text-3xl font-black uppercase leading-none mb-6">
                  AEO / GEO
                </h3>
                <p className="text-lg font-light leading-relaxed mb-8 flex-grow">
                  Optimise for Answer & Generative Engines (AI Overview, Copilot). A crucial emerging channel for maintaining visibility.
                </p>
                <div className="flex flex-wrap gap-2 mt-auto">
                  {["Answer Engines", "Generative Content", "Structured Data"].map((tag, idx) => (
                    <span key={idx} className="text-xs uppercase tracking-widest font-bold border border-current px-3 py-1 opacity-70">
                      {tag}
                    </span>
                  ))}
              ...
              {/* Card 03 */}
              <div className="group relative bg-surface p-10 lg:p-14 border-l-8 border-on-surface flex flex-col hover:bg-primary-container hover:text-on-primary-container transition-all duration-500 min-h-[340px]">
                <h3 className="text-3xl font-black uppercase leading-none mb-6">
                  Local SEO
                </h3>
                <p className="text-lg font-light leading-relaxed mb-8 flex-grow">
                  Capture high-intent searches in your area & drive local enquiries through map visibility, and highly-targeted landing pages.
                </p>
                <div className="flex flex-wrap gap-2 mt-auto">
                  {["Business Profile", "Map Visibility", "Local Landings"].map((tag, idx) => (
                    <span key={idx} className="text-xs uppercase tracking-widest font-bold border border-current px-3 py-1 opacity-70">
                      {tag}
                    </span>
                  ))}
              ...
              <div className="group relative bg-surface p-10 lg:p-14 border-l-8 border-secondary flex flex-col hover:bg-on-background hover:text-surface transition-all duration-500 min-h-[340px]">
                ...
                <p className="text-lg font-light leading-relaxed mb-8 flex-grow">
                  Build uncompromising authority through high-quality media outreach, placements, and content-led strategic campaigns.
                </p>
                <div className="flex flex-wrap gap-2 mt-auto">
                  {["Media Outreach", "Link Acquisition", "Brand Authority"].map((tag, idx) => (
                    <span key={idx} className="text-xs uppercase tracking-widest font-bold border border-current px-3 py-1 opacity-70">
                      {tag}
                    </span>
                  ))}
        ...
        {/* ─── PROCESS ─── */}
        <section id="how-it-works" className="py-32 px-8 bg-surface-container-low relative overflow-hidden">
          <div className="max-w-screen-2xl mx-auto relative z-10">
            <div className="mb-24 flex flex-col md:flex-row justify-between items-end gap-8">
              <div>
                ...
                <p className="text-2xl max-w-xl text-on-surface-variant font-light">
                  Built for steady, exponential growth. A methodology refined across countless audits and deployments.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 border-t-2 border-on-surface mt-16 pt-12 gap-12 md:gap-4">
              {[
                { num: "01", title: "Discover", desc: "Deep-dive into your market, spy on competition, and measure performance to extract pure opportunity." },
                { num: "02", title: "Build", desc: "Deploy the foundations. From deep technical triage to scalable programmatic content structures." },
                { num: "03", title: "Improve", desc: "Refine continuous performance models based on structured data and real user interactions." },
                { num: "04", title: "Scale", desc: "Identify traction points and apply severe scaling to grow conversions seamlessly." }
              ].map((step, i) => (
                <div key={i} className="flex flex-col group py-4 pr-4">
        ...
        <section className="py-32 px-8 bg-surface relative">
          <div className="max-w-screen-2xl mx-auto flex flex-col lg:flex-row justify-between gap-16 lg:items-center border-t-2 border-b-2 border-on-surface py-24">
            ...
            <div className="lg:max-w-md">
              ...
              <p className="text-xl text-on-surface-variant font-light leading-relaxed mb-8">
                We focus uncompromisingly on outcomes that radically reshape the bottom line. Execution grounded entirely in reality.
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-16 gap-x-12 flex-grow">
              {[
                { category: "Marketplace Growth", stat: "2.1M → 6.1M", desc: "Scaled organic traffic sessions within two years." },
                { category: "Media & Publishing", stat: "+67%", desc: "Exploded distinct audience reaching the #1 position." },
                { category: "Product-Led Growth", stat: "25% Lift", desc: "Compound growth via deep technical refactoring." },
                { category: "AI Search", stat: "New Channel", desc: "Unlocked organic pipeline via generative search." }
              ].map((study, i) => (
                <div key={i} className="flex flex-col border-l-4 border-secondary pl-6">
        ...
        {/* ─── THE FLYWHEEL ─── */}
        <section className="py-32 px-8 bg-surface-container-low relative overflow-hidden">
          <div className="max-w-screen-2xl mx-auto relative z-10 flex flex-col items-center text-center">
            <span className="font-label uppercase tracking-[0.3em] text-xs text-secondary font-bold mb-6 block">
              The Engine
            </span>
            <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tighter leading-none mb-8">
            ...
            <p className="text-xl md:text-2xl text-on-surface-variant max-w-3xl font-light leading-relaxed mb-16">
              Most providers focus on isolated tricks. We engineer a compounding engine that operates continuously, aggregating unshakeable power over time.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left w-full max-w-4xl mt-8">
              {[
                ...
                <div key={i} className="bg-surface p-8 border-t-4 border-on-surface shadow-sm">
        ...
        {/* ─── CTA ─── */}
        <section id="contact-cta" className="py-32 px-8 bg-on-background text-surface text-center relative overflow-hidden">
          <div className="max-w-screen-2xl mx-auto relative z-10 flex flex-col items-center">
            ...
            <p className="text-xl md:text-2xl text-surface-variant max-w-2xl font-light leading-relaxed mb-12">
              Stop relying on increasingly expensive paid ads. Let&apos;s engineer an organic growth system tailored to scale you.
            </p>
            <a
              href="/contact"

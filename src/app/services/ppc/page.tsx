      ...
      <main id="main-content">
        ...
        <section className="pt-12 pb-16 px-8">
          <h1 className="text-giant font-black uppercase mb-12">
            ...
            <span className="block text-on-surface md:mb-4 lg:mb-6">
              CLICKS.
            </span>
          ...
          <div className="max-w-4xl border-l-[6px] border-on-surface pl-8 md:pl-10 lg:pl-12 py-2 ml-2 md:ml-[calc(clamp(4.25rem,15vw,10rem)*0.6)]">
            <p className="text-lg md:text-2xl font-normal leading-relaxed mb-8 text-on-surface/90">
              PPC that reduces Customer Acquisition Cost (CAC) and scales
              revenue predictably. We treat your budget like our own
              product—optimising for LTV, eliminating waste, and targeting exact
        ...
        {/* Stats */}
        <section className="border-y border-surface-variant py-16 px-8">
          <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-surface-variant">
            {stats.map((s) => (
              <div
                key={s.label}
          ...
          <div className="max-w-screen-2xl mx-auto">
            <div className="mb-24">
              ...
              <p className="text-2xl max-w-xl text-on-surface-variant font-light">
                We bridge the gap between user intent, messaging, and the

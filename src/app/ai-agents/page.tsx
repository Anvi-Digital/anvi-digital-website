...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Agents — Practical AI Built for Real Business Work | ANVI DIGITAL",
    description:
      "We design and implement AI agents that fit into your workflows, helping you move faster, uncover insights, and execute with more clarity.",
  },
  alternates: {
    canonical: "https://anvi.digital/ai-agents",
  },
};
...
const steps = [
  ...
  },
  {
    ...
    title: "Implement",
    description:
      "We integrate AI agents into your systems and processes.",
  },
  {
    number: "04",
    title: "Improve",
    description:
      "We refine performance using real data and feedback.",
  },
];
  ...
  return (
    <>
      ...
      <main id="main-content">
            ...
            <div className="stagger-grid">
              <div className="col-start-1 col-span-12 md:col-start-7 md:col-span-6 border-l-4 border-on-surface pl-8 py-4">
                <p className="text-base md:text-2xl font-light leading-snug mb-4 text-on-surface-variant">
                  Practical systems that help your business analyse, operate,
                  and grow more effectively.
                </p>
                <p className="text-base md:text-lg font-light leading-relaxed mb-8 text-on-surface-variant/70">
                  We design and implement AI agents that fit into your
                  workflows, helping you move faster, uncover insights, and
                  execute with more clarity.
                </p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-16">
              ...
              <div className="md:max-w-lg md:pt-16">
                <p className="text-xl md:text-2xl font-light leading-relaxed text-on-surface-variant mb-8">
                  AI is everywhere, but most businesses struggle to apply it in
                  a meaningful way.
                </p>
          ...
          <div className="max-w-screen-2xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              {useCases.map((uc, i) => (
                <div
                  key={uc.title}
                  className={`group relative bg-surface p-12 lg:p-16 border-l-8 ${uc.borderColor} flex flex-col justify-between min-h-100 ${uc.hoverBg} transition-all duration-500`}
                >
            ...
            <div className="flex flex-col md:flex-row gap-16 md:gap-24">
              ...
              <div className="md:w-1/2 md:pt-12">
                <p className="text-xl md:text-2xl font-light leading-relaxed text-on-surface-variant mb-12">
                  AI delivers value when it&apos;s connected to real business
                  needs.
                </p>
                <p className="text-lg font-light text-on-surface-variant mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 border-t-2 border-on-surface">
              {steps.map((step, i) => {
                ...
                return (
                  <div
                    key={step.number}
                    className={`p-12 md:p-20 border-b-2 ${isEven ? "md:border-r-2" : ""} border-on-surface flex flex-col justify-between ${
                      i === 1
                        ? "bg-surface"
                        : i === 2
                          ? "bg-secondary/5"
                    ...
                    <div className={`mb-12 ${isOdd ? "flex justify-end" : ""}`}>
                      <span
                        className={`text-8xl md:text-[10rem] font-black leading-none ${
                          i === 0 || i === 3 ? "text-outline" : "text-on-surface"
                        }`}
                      >
                        {step.number}
                      </span>
        ...
        {/* ─── FINAL CTA ─── */}
        <section
          className="py-32 px-8 bg-on-background text-surface"
          id="contact-cta"
        >
        ...
        {/* ─── FOOTER LINE ─── */}
        <section className="py-12 px-8 bg-on-background border-t border-surface/10">
          <div className="max-w-screen-2xl mx-auto">
